...
class BookInstance(models.Model):
    ...
    language = models.ManyToManyField('Language', help_text='Idioma de la instancia del libro')
    ...
    def get_return_days(self):
        days_left = (self.due_back - date.today()).days
        # get_status_display() Autogenerated function for "choices" field
        return self.get_status_display() + (', ' if days_left >= 0 else ', LATE, ') + str(days_left)
    get_return_days.short_description = 'Status'
...
class Publisher(models.Model):
    ...
    def get_absolute_url(self):
        """Returns the URL to access a detail record for t"""
...
class Client(models.Model):
    ...
    def get_absolute_url(self):
        """Returns the URL to access a particular author instance."""
        return reverse('client', args=[str(self.pk)])
